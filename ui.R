...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    p(strong(em("Github repository:",a("Developing Data Products - Peer Assessment Project; Shiny App",href="https://github.com/ALIINAM/DevelopingDataProducts"))))
  ),
  mainPanel(
    tabsetPanel(
